...
OPENAI_MNIST_TEMPLATES = [
    lambda c: f'a photo of the number: "{c}".',
]

stanfordcard_classes = [
...
OPENAI_SUN397_TEMPLATES = [
    lambda c: f"a photo of a {c}.",
    lambda c: f"a photo of the {c}.",
]

svhn_classes = mnist_classes

OPENAI_SVHN_TEMPLATES = OPENAI_MNIST_TEMPLATES
...
dataset2classes_templates = {
    "imagenet": (imagenet_classes, OPENAI_IMAGENET_TEMPLATES),
    "gtsrb": (gtsrb_classes, OPENAI_GTSRB_TEMPLATES),
    ...
    "sketch": (imagenet_classes, sketch_templates),
    "cifar10": (cifar10_classes, cifar10_template),
    "cifar100": (cifar100_classes, cifar100_template),
    "pacs": (pacs_classes, OPENAI_IMAGENET_TEMPLATES),
}
dataset_names = {
    "imagenet": "ImageNet",
    "random": "Random",
